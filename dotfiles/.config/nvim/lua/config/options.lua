...
opt.softtabstop = 3 -- Number of spaces tabs count for
opt.spelllang = { "en" }
...
opt.whichwrap = "b,s,<,>,h,l" -- Move to next line with theses keys
opt.wildchar = vim.api.nvim_replace_termcodes("<C-n>", true, true, true):byte() -- Wildmenu cmdline completion key
