{
  ...
  programs.plasma = {
    ...
    configFile = {
      ...
      "plasma-org.kde.plasma.desktop-appletsrc"."Containments.2.Applets.5.Configuration.General"."launchers" = "preferred://browser,preferred://filemanager,applications:org.kde.konsole.desktop";
      ...
      "plasma-org.kde.plasma.desktop-appletsrc"."Containments.2.Applets.6"."plugin" = "org.kde.plasma.pager";
